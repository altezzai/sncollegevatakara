...
--
-- Host: 127.0.0.1    Database: sncollege
-- ------------------------------------------------------
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$600000$4Scq2BccsUtNwRk52wFk01$csKIh0FHuwEAzmZrXN/ex/85P9nXoBddm2mckt3Zw8o=','2025-07-05 05:32:53.038230',1,'snclg@vdk','','','sncvatakara@gmail.com',1,1,'2024-01-08 16:31:06.574232');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(12,'myapp','banner'),(7,'myapp','employee'),(8,'myapp','event'),(9,'myapp','news'),(11,'myapp','newsimage'),(10,'myapp','notification'),(6,'sessions','session');
...
DROP TABLE IF EXISTS `myapp_banner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `myapp_banner` WRITE;
/*!40000 ALTER TABLE `myapp_banner` DISABLE KEYS */;
INSERT INTO `myapp_banner` VALUES (3,'banners/sn6.jpeg','https://sncollegevadakara.org/',1,'2025-07-05 05:49:31.740170'),(4,'banners/coverpic1.jpg','https://sncollegevadakara.org/',1,'2025-07-05 05:49:44.551775'),(5,'banners/coverpic2.webp','https://sncollegevadakara.org/',1,'2025-07-05 05:49:54.623031'),(7,'banners/sn4.jpg','https://sncollegevadakara.org/',1,'2025-07-05 05:50:26.125498');
/*!40000 ALTER TABLE `myapp_banner` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-07-05 11:42:37
