...
urlpatterns = [
    ...
    path('academics/admission-process', views.admission_process, name='admission_process'),
    path('academics/programme-syllabus', views.programme_syllabus, name='programme_syllabus'),
    path('academics/programme-syllabus/admin/', views.programme_course_list, name='programme_course_list'),
    path('academics/programme-syllabus/admin/create/', views.programme_course_create, name='programme_course_create'),
    path('academics/programme-syllabus/admin/<int:course_id>/update/', views.programme_course_update, name='programme_course_update'),
    path('academics/programme-syllabus/admin/<int:course_id>/delete/', views.programme_course_delete, name='programme_course_delete'),
    path('academics/academic-calendar', views.academic_calendar, name='academic_calendar'),
    path('academics/library', views.library, name='library'),
