...
urlpatterns = [
    ...
    path('campus-life/admin/other-clubs-committees/people/', views.club_committee_person_list, name='club_committee_person_list'),
    path('campus-life/admin/other-clubs-committees/people/create/', views.club_committee_person_create, name='club_committee_person_create'),
    path('campus-life/admin/other-clubs-committees/people/<int:person_id>/update/', views.club_committee_person_update, name='club_committee_person_update'),
    path('campus-life/admin/other-clubs-committees/people/<int:person_id>/delete/', views.club_committee_person_delete, name='club_committee_person_delete'),
